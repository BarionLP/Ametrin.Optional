...
public static class DebugExtensions
{
    ...
    public static void AssertSuccess(this ErrorState state, string message = "ErrorState was failure") => Debug.Assert(state._success == true, message);
    public static void AssertSuccess<T>(this ErrorState<T> state, string message = "ErrorState was failure") => Debug.Assert(state._success == true, message);
}
