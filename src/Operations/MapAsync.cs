...
{
    public static async Task<Option<TResult>> Map<TValue, TResult>(this Task<Option<TValue>> optionTask, Func<TValue, TResult> map)
    ...
    public static async Task<Result<TResult>> Map<TValue, TResult>(this Task<Result<TValue>> optionTask, Func<TValue, TResult> map)
